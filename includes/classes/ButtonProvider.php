...
class ButtonProvider {
    ...
    public static function createSubscriberButton($con, $userToObj, $userLoggedInObj) {
        ...
        $isSubscibedTo = $userLoggedInObj->isSubscribedTo($userTo);
        $buttonText = $isSubscibedTo ? "SUBSCRIBED" : "SUBSCRIBE";
        $buttonText .= " " . $userToObj->getSubscriberCount();
        $buttonClass = $isSubscibedTo ? "unsubscribe button" : "subscribe button";
